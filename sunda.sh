...
"'&reply_markup={"inline_keyboard":[[{"text":"Telegram","url":"https://t.me/putrasunda_vpn"},{"text":"Whatsapp","url":"wa.me/6283835753089"}]]}'
curl -s --max-time $TIMES -d "chat_id=$CHATID&disable_web_page_preview=1&text=$TEXT&parse_mode=html" $URL >/dev/null
}
clear
function pasang_ssl() {
clear
print_install "Save SSL To Domain"
...
function udp_mini(){
clear
print_install " Service limit "
wget "http://raw.githubusercontent.com/Nelihsukarna1980/sunda/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
