...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Nelihsukarna1980/sunda/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Nelihsukarna1980/sunda/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Nelihsukarna1980/sunda/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
TIMES="10"
CHATID="5969033638"
KEY="6308790457:AAEVT7HXhlU-E2NJaSs82oNSA2Y5pwwb_RU"
URL="https://api.telegram.org/bot$KEY/sendMessage"

# // install paket
function base_package() {
clear
print_install "Install paket script"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Nelihsukarna1980/sunda/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Nelihsukarna1980/sunda/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"Telegram","url":"https://t.me/jabar_putra"},{"text":"Whatsapp","url":"wa.me/6283835753089"}]]}'
curl -s --max-time $TIMES -d "chat_id=$CHATID&disable_web_page_preview=1&text=$TEXT&parse_mode=html" $URL >/dev/null
}
clear
function pasang_ssl() {
clear
print_install "Ssl tool"
...
wget https://raw.githubusercontent.com/Nelihsukarna1980/sunda/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
...
echo -e "\e[92;1m  Telegram : @jabar_putra \e[0m"
echo -e "\e[92;1m  Happy Surfing Best Script Tunneling  \e[0m"
echo ""
echo -e ""
echo ""
